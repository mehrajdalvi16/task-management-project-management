    ...
    $('#manage-project').submit(function(e){
        ...
        if (endDate < startDate) {
            if (!$('.date-error-message').length) {
                $('<div class="text-danger date-error-message">End date cannot be less than start date.</div>').insertAfter('input[name="end_date"]');
            } else {
                $('.date-error-message').text('End date cannot be less than start date.');
            }
            return; // Prevent form submission
        }

        // Remove error message if end date is valid
